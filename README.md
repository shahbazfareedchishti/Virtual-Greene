...
Live Application: [https://virtualgreene.streamlit.app/](https://virtualgreene.streamlit.app/)
...
You can run this application either locally using Python or via a container using Podman.

### Environment Configuration

Before running the application (either locally or via container), create a `.env` file in the root directory and add your Groq API key:
...
### Option 2: Run via Container (Podman on RHEL)
